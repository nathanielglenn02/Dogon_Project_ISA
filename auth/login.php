                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h4 class="text-center font-weight-light my-4">Login - SMA Dogon</h4>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="text-muted-small">Copyright &copy; SMA Dogon <?= date('Y') ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
