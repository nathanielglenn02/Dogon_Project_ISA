...
$queryGuruku = mysqli_query($koneksi, "SELECT * FROM guruku");
$jmlGuruku = mysqli_num_rows($queryGuruku);

$lulusUjian = mysqli_query($koneksi, "SELECT * FROM ujian WHERE hasil_ujian ='LULUS'");
$jmlLulus = mysqli_num_rows($lulusUjian);

$gagalUjian = mysqli_query($koneksi, "SELECT * FROM ujian WHERE hasil_ujian ='GAGAL'");
